...
?>
<article class="post-card bg-surface-container-low rounded-xl border border-outline-variant/10 p-4 hover:bg-surface-container transition-all duration-300 group relative flex gap-3" id="post-<?php echo $post['id']; ?>">
    ...
    <div class="flex-1 flex flex-col gap-3 min-w-0">
        ...
        <!-- Header: User details, tagline, and options button -->
        ...
        <!-- Actions Footer -->
        <div class="flex justify-between items-center mt-1 text-on-surface-variant text-sm font-medium">
            <div class="flex gap-4 items-center">
                ...
                <!-- Telsizle (Repost) -->
                <button onclick="App.toggleRepost(this, <?php echo $post['id']; ?>)" class="flex items-center gap-xs hover:text-primary transition-colors <?php echo !empty($post['viewer_reposted']) ? 'reposted text-primary' : ''; ?>">
                ...
                <!-- Bahşiş (Tip) -->
                <button onclick="App.flash('Bahşiş özelliği yakında aktif edilecek! 💸', 'info')" class="flex items-center gap-xs hover:text-green-400 transition-colors opacity-70 hover:opacity-100">
                    <span class="material-symbols-outlined text-xl">payments</span>
                    <span class="text-label-md font-bold">Bahşiş</span>
                </button>
            </div>

            <!-- Bookmark/Save Button (Copies Link) -->
        ...
        <div class="post-comments-section mt-1 pt-3 border-t border-dashed border-white/10" id="comments-section-<?php echo $post['id']; ?>" style="display:none;">
