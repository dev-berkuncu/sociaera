...
<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mb-8">
    ...
    $statCards = [
        ...
        ['icon' => 'payments',           'value' => '$' . number_format($stats['monthly_earnings'], 0), 'label' => 'Aylık Gelir',       'color' => 'text-emerald-500'],
        ['icon' => 'trending_down',      'value' => '-$' . number_format($stats['monthly_expenses'], 0),'label' => 'Aylık Gider',       'color' => 'text-red-500'],
        ['icon' => 'account_balance',    'value' => '$' . number_format($stats['monthly_earnings'] - $stats['monthly_expenses'], 0), 'label' => 'Aylık Net Kazanç', 'color' => 'text-blue-500'],
