...
<div class="fixed inset-0 z-[-2] bg-no-repeat" style="top: 64px; background-image: url('<?php echo BASE_URL; ?>/assets/images/hero-bg.jpg?v=<?php echo $heroV; ?>'); background-size: cover; background-position: center top; filter: blur(2px);"></div>
