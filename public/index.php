...
<div class="fixed top-[64px] inset-x-0 bottom-0 z-[-2] bg-cover bg-top bg-no-repeat blur-[3px]" style="background-image: url('<?php echo BASE_URL; ?>/assets/images/hero-bg.jpg?v=<?php echo $heroV; ?>');"></div>
<div class="fixed top-[64px] inset-x-0 bottom-0 z-[-1] bg-background/80"></div>
<!-- TopNavBar -->
