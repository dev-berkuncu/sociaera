...
<div class="fixed inset-0 z-[-2] bg-cover bg-[center_20%] md:bg-[center_15%] bg-no-repeat blur-[3px] scale-105" style="background-image: url('<?php echo BASE_URL; ?>/assets/images/hero-bg.jpg?v=<?php echo $heroV; ?>');"></div>
