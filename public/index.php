...
<div class="fixed inset-0 z-[-2] bg-cover bg-top bg-no-repeat blur-[3px]" style="background-image: url('<?php echo BASE_URL; ?>/assets/images/hero-bg.jpg?v=<?php echo $heroV; ?>');"></div>
