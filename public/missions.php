...
<section class="flex-1 flex flex-col gap-stack-md max-w-3xl w-full mx-auto lg:mx-0">
    <div class="flex items-center justify-between flex-wrap gap-3 mb-2">
        ...
        <div class="bg-gradient-to-r from-primary-container/20 to-surface-container text-primary-container px-4 py-1.5 rounded-full font-label-md text-label-md border border-primary-container/30 flex items-center gap-2">
            ...
            <?php echo $earnedCount; ?>/<?php echo $totalCount; ?> rozet
        </div>
    </div>
    ...
    <div>
        ...
        <div class="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-3">
            ...
            <div class="flex flex-col items-center gap-1.5 p-3 bg-[#1E293B]/80 border border-white/10 rounded-xl hover:border-white/20 transition-colors group" title="<?php echo escape($b['name'] . ' — ' . $b['desc']); ?>">
                <div class="w-12 h-12 rounded-full flex items-center justify-center shadow-[0_0_15px_rgba(0,0,0,0.3)]" style="background: <?php echo $b['color']; ?>20; border: 2px solid <?php echo $b['color']; ?>50;">
            ...
            <div class="bg-[#1E293B]/80 backdrop-blur-[20px] border rounded-xl p-5 shadow-[0_10px_25px_-15px_rgba(15,23,42,0.3)] flex items-center gap-4 transition-all <?php echo $b['earned'] ? 'border-emerald-500/20 bg-emerald-500/5' : 'border-white/10 hover:border-white/20'; ?>">
                ...
                <div class="flex-grow min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                        ...
                        <?php if ($b['earned']): ?>
                        <span class="bg-emerald-500/20 text-emerald-400 text-[9px] font-black px-1.5 py-0.5 rounded border border-emerald-500/30 uppercase tracking-wider">Tamamlandı</span>
                        <?php endif; ?>
                    </div>
