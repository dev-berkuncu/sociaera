    ...
    <div class="w-full max-w-md relative z-10">
        <div class="bg-[#1E293B]/80 backdrop-blur-[20px] border border-white/10 rounded-2xl p-8 md:p-10 shadow-[0_20px_40px_-15px_rgba(15,23,42,0.5)]">
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-black text-on-surface mb-2"><?php echo APP_NAME; ?>'ya Katıl</h1>
                <p class="text-slate-400 text-sm">GTA World hesabınla hemen kayıt ol ve topluluğa katıl</p>
            </div>
            ...
            <div class="mt-6 text-center text-sm text-slate-400">
                Zaten hesabın var mı? <a href="<?php echo BASE_URL; ?>/login" class="text-primary-container font-bold hover:underline">Giriş Yap</a>
            </div>
        </div>
    </div>
</div>
